...
import { UserRepository, RoleRepository, PermissionRepository } from '@auth-lib';

@Module({
  imports: [
    TypeOrmModule.forRoot(dbdatasource),
    TypeOrmModule.forFeature([User, RefreshToken, UserRepository, Permission, PermissionRepository, Role, RoleRepository]),
